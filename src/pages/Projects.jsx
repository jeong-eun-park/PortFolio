      ...
      <div className="relative z-30">
        <div className="flex max-w-full h-[100vh] justify-start items-center py-[144px] px-[150px]">
          <div className="flex w-[100%] flex-col px-[10px] ">
            ...
            <div className="flex max-w-full justify-between mt-8">
              {projects.map((project, index) => {
                return (
                  <div
                    key={index}
                    className="flex rounded-2xl w-[300px] h-[450px] p-5 bg-[#25385B] relative "
                  >
                    <div className="rounded flex flex-col relative w-full h-full text-[#FFF]">
                      <div className="h-[215px]">
                        <img
                          src={project.img}
                          className="rounded-2xl object-fill h-[100%]"
                        />
                      </div>
